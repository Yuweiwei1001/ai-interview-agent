...
public interface InterviewSessionMapper {
    @Insert("INSERT INTO interview_session(id, user_id, resume_id, jd_id, direction, persona, phase, duration_minutes, knowledge_base_id, status, interview_plan) VALUES(#{id}, #{userId}, #{resumeId}, #{jdId}, #{direction}, #{persona}, #{phase}, #{durationMinutes}, #{knowledgeBaseId}, #{status}, #{interviewPlan})")
