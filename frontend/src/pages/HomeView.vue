  ...
  <div class="min-h-screen bg-slate-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <router-link to="/eval"
          class="group bg-white rounded-2xl shadow-card p-6 hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-200">
          <div class="w-10 h-10 rounded-xl bg-violet-50 text-violet-600 flex items-center justify-center text-lg font-bold mb-3">测</div>
          <h3 class="font-semibold text-slate-800 group-hover:text-violet-600 transition-colors duration-200">Agent 评测</h3>
